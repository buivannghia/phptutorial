    ...
    <body>
        ...
        <div class="container-fluid w-25 mx-auto">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <input type="submit" name="plus" id="plus" value="a + b" class="btn btn-success mt-2">
                <input type="submit" name="minus" id="minus" value="a - b" class="btn btn-primary mt-2">
                <input type="submit" name="multiply" id="multiply" value="a * b" class="btn btn-danger mt-2">
                <input type="submit" name="divide" id="divide" value="a / b" class="btn btn-warning mt-2">
            </form>
